  ...
  const sections = [
    {
      ...
      title: 'OVERVIEW',
      content: [
        'This website is operated by H.B.Metals. Throughout the site, the terms "we", "us" and "our" refer to H.B.Metals. H.B.Metals offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.',
    ...
    },
    {
      ...
      content: [
        'You agree to indemnify, defend and hold harmless H.B.Metals and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys\' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.'
      ]
    },
    {
      id: 'severability',
    ...
    },
    {
      ...
      content: [
        'Questions about the Terms of Service should be sent to us at info@tasterider.in'
      ]
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-8 max-w-4xl overflow-x-hidden w-full">
      ...
      >
        ...
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-stone-800 border-b pb-4 border-amber-200">Terms and Conditions</h1>
