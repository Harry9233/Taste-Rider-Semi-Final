...
const TasteRiderSpecialsPage = ({ products, onAddToCart, searchTerm, onSearchChange, cartItemCount, selectedCategory, cartItems, onUpdateQuantity }) => {
  ...
  const pageTitle = "Our Signature Taste Rider Specials";

  const filteredProducts = products.filter(p => p.category === 'Taste Rider Specials');
...
export default TasteRiderSpecialsPage;
